...
INSERT INTO "new_Sale" ("cae", "caeExpiration", "clientId", "createdAt", "date", "id", "invoiceNumber", "invoiceType", "organizationId", "total", "updatedAt", "userId") SELECT "cae", "caeExpiration", "clientId", "createdAt", "date", "id", "invoiceNumber", "invoiceType", "organizationId", "total", "updatedAt", "userId" FROM "Sale";
DROP TABLE "Sale";
